...
#### BAVAE - sample
#### BAVAE GEX only - sample - 20 dims
#### BAVAE ATAC only - sample - 20 dims
#### BAVAE GEX only - sample - 10 dims
#### BAVAE ATAC only - sample - 10 dims
...
for seed in seeds:     
    model_param_mapping['BAVAE_sample_100_seed_{}'.format(seed)] = {}
    model_param_mapping['BAVAE_sample_100_seed_{}'.format(seed)]['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': 'sample'}
    model_param_mapping['BAVAE_sample_100_seed_{}'.format(seed)]['Liam_params'] = {'adversarial_training': True, 'n_latent': 20}


    model_param_mapping['CVAE_sample_100_seed_{}'.format(seed)] = {}
    model_param_mapping['CVAE_sample_100_seed_{}'.format(seed)]['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': 'sample'}
    model_param_mapping['CVAE_sample_100_seed_{}'.format(seed)]['Liam_params'] = {'adversarial_training': False, 'conditional_training': True, 'n_latent': 20}
    ...
    model_param_mapping['BAVAE_sample_100_rna_only_seed_{}'.format(seed)] = {}
    model_param_mapping['BAVAE_sample_100_rna_only_seed_{}'.format(seed)]['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': 'sample', 'rna_only': True}
    model_param_mapping['BAVAE_sample_100_rna_only_seed_{}'.format(seed)]['Liam_params'] = {'adversarial_training': True, 'n_latent': 10,
                                                                      'rna_only': True}

    model_param_mapping['BAVAE_sample_100_atac_only_seed_{}'.format(seed)] = {}
    model_param_mapping['BAVAE_sample_100_atac_only_seed_{}'.format(seed)]['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': 'sample'}
    model_param_mapping['BAVAE_sample_100_atac_only_seed_{}'.format(seed)]['Liam_params'] = {'adversarial_training': True, 'n_latent': 10,
                                                                      'atac_only': True}
...
model_param_mapping['BAVAE_sample_100_rna_only_seed_0'] = {}
model_param_mapping['BAVAE_sample_100_rna_only_seed_0']['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': 'sample', 'rna_only': True}
model_param_mapping['BAVAE_sample_100_rna_only_seed_0']['Liam_params'] = {'adversarial_training': True, 'n_latent': 10,
                                                                  'rna_only': True}

# models GEX and ATAC lib size (but batch independent)
model_param_mapping['VAE_100_seed_0'] = {}
model_param_mapping['VAE_100_seed_0']['setup_anndata_params'] = {'chrom_acc_obsm_key': 'ATAC', 'batch_key': None}
model_param_mapping['VAE_100_seed_0']['Liam_params'] = {'n_latent': 20, 'dispersion_gex': 'gene', 'dispersion_atac': 'constant'}
