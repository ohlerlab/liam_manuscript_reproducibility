...
model_param_mapping['Liam_params'] = {'adversarial_training': True, 'n_latent': 20, 'factor_adversarial_loss': 5.0}

# Seeds (either for random data partition (training with random seed 0, or for training))
seeds = [8831, 234, 11, 9631, 94]

for use_case in ['mosaic_full', 'mosaic_a', 'mosaic_b', 'mosaic_atac_a', 'mosaic_rest_a', 'mosaic_atac_b', 'mosaic_rest_b', 'paired_full']:
    for seed in seeds:
