...
for seed in seeds:
    model = 'MultiVI_seed_{}_timing_t4'.format(seed)
    print(model)
    ...
    print('{}: {}'.format(model, timedelta(seconds=end-start)), file=open('Time_Wallclock_training_run_time_revisions_MultiVI_r1.txt', 'a'))
